...
def astro():
    ...
    time = [ 'today', 'tomorrow', 'weekly', 'monthly', 'yearly' ] 
...
# Points
    ...
    elif query.lower() in nnode:
        os.system('python3 ~/.grungegirl/astrology/points/nnode.py')

    elif query.lower() in snode:
        os.system('python3 ~/.grungegirl/astrology/points/snode.py')

# ----------------------- Ascendant

    elif query.lower() in asc:
        os.system('python3 ~/.grungegirl/astrology/points/ascendant.py')

# Signs

    elif query.lower() == "aries":
        os.system("python3 ~/.grungegirl/astrology/signs/aries.py")


    elif query.lower() == "taurus":
        os.system('python3 ~/.grungegirl/astrology/signs/taurus.py')


    elif query.lower() == 'gemini':
        os.system('python3 ~/.grungegirl/astrology/signs/gemini.py')


    elif query.lower() == 'cancer':
        os.system('python3 ~/.grungegirl/astrology/signs/cancer.py')


    elif query.lower() == 'leo':
        os.system('python3 ~/.grungegirl/astrology/signs/leo.py')


    elif query.lower() == 'virgo':
        os.system('python3 ~/.grungegirl/astrology/signs/virgo.py')


    elif query.lower() == 'libra':
        os.system('python3 ~/.grungegirl/astrology/signs/libra.py')


    elif query.lower() == 'scorpio':
        os.system('python3 ~/.grungegirl/astrology/signs/scorpio.py')


    elif query.lower() == 'sagittarius':
        os.system('python3 ~/.grungegirl/astrology/signs/sag.py')


    elif query.lower() == 'capricorn':
        os.system('python3 ~/.grungegirl/astrology/signs/cap.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/signs/aqua.py')

    elif query.lower() == 'pisces':
        os.system('python3 ~/.grungegirl/astrology/signs/pisces.py')
...
# Houses
    ...
    hs3 = [ 'hs3', 'the third house', 'house three' ] 

    if query.lower() in hse1:
        os.system('python3 ~/.grungegirl/astrology/houses/firsthouse.py')

    elif query.lower() in hs2:
        os.system('python3 ~/.grungegirl/astrology/houses/secondhouse.py')

    elif query.lower() in hs3:
        os.system('python3 ~/.grungegirl/astrology/houses/thirdhouse.py')

    elif query.lower() == 'hs4':
        os.system('python3 ~/.grungegirl/astrology/houses/fourthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/fifthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/sixthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/seventhhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/eighthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/ninthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/tenthhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/eleventhhouse.py')
        ...
        os.system('python3 ~/.grungegirl/astrology/houses/twelfthhouse.py')
...
# Planets
        ...
        os.system('python3 ~/.grungegirl/astrology/planets/sun.py')


    elif query.lower() == 'earth':
        os.system('python3 ~/.grungegirl/astrology/planets/earth.py')


    elif query.lower() == 'mercury':
        os.system('python3 ~/.grungegirl/astrology/planets/mercury.py')


    elif query.lower() == 'moon':
        os.system('python3 ~/.grungegirl/astrology/planets/moon.py')


    elif query.lower() == 'venus':
        os.system('python3 ~/.grungegirl/astrology/planets/venus.py')


    elif query.lower() == 'mars':
        os.system('python3 ~/.grungegirl/astrology/planets/mars.py')


    elif query.lower() == 'jupiter':
        os.system('python3 ~/.grungegirl/astrology/planets/jupiter.py')


    elif query.lower() == 'saturn':
        os.system('python3 ~/.grungegirl/astrology/planets/saturn.py')

    elif query.lower() == 'uranus':
        os.system('python3 ~/.grungegirl/astrology/planets/uranus.py')


    elif query.lower() == 'neptune':
        os.system('python3 ~/.grungegirl/astrology/planets/neptune.py')


    elif query.lower() == 'pluto':
        os.system('python3 ~/.grungegirl/astrology/planets/pluto.py')

# Asteroids

    elif query.lower() == 'lilith':
        os.system('python3 ~/.grungegirl/astrology/asteroids/lilith.py')

    elif query.lower() == 'chiron':
        os.system('python3 ~/.grungegirl/astrology/asteroids/chiron.py')

    elif query.lower() == 'pallas':
        os.system('python3 ~/.grungegirl/astrology/asteroids/pallas.py')
...
# ------------------------ Bi-Quintile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/bi-quin.py')
...
# ------------------------ Conjunction
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/conjunction.py')
...
# ------------------------ Opposition
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/opposition.py')
...
# ------------------------- Quincunx
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/quincunx.py')
...
# ------------------------- Quintile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/quintile.py')
...
# ------------------------- Semi-Quintile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/sem-quin.py')
...
# ------------------------ Semi-Sextile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/semi-sextile.py')
...
# ------------------------- Semi-Square
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/semi-sq.py')
...
# ------------------------- Sesquiquadrate
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/sesquisq.py')
...
# ------------------------- Square
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/square.py')
...
# -------------------------- Trine
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/trine.py')
...
# -------------------------- Septile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/septile.py')
...
# --------------------------- Sextile
        ...
        os.system('python3 ~/.grungegirl/astrology/aspects/sextile.py')

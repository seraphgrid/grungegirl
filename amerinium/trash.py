...
def sav2():
    ...
    str9 = repr(pwrcount)
    file.write("pwrcountn = " + str9 + "\n")
    str10 = repr(pwrdmg)
    file.write("pwrdmgn = " + str10 + "\n")
    str11 = repr(in_battle)
    file.write("in_battlen = " + str11 + "\n")
...
def command_line():
    ...
    command_line1 = input("Command: ")

    
    

    if command_line1 == valid_input[0]:
        mining()
        
    if command_line1 == valid_input[1]:
        sell()
        
    if command_line1 == valid_input[2]:
        upg()
        
    if command_line1 == valid_input[3]:
        sav()
        
    if command_line1 == valid_input[4]:
        automine()

    if command_line1 == valid_util[0]:
        os.system('clear')

    if command_line1 == valid_util[1]:
        sav()
        os.system('grungegirl')
        
    if command_line1 != valid_input:
        command_line()

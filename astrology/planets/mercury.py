def merc():
    ...
    mercuryInfo = "Mercury is the planet of analysis and communication. It handles the way that one processes and uses any amount of information given to them. It can also determine the lens through which one handles their feelings or handles negative communication. The strongest placements of Mercury imply the strongest mind. Negative or retrograde placements can denote trouble learning or otherwise communicating."
